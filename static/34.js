  ...
  [34],
  {
    4290: function (e, t, i) {
      ...
      function Navigation(e) {
        ...
        function init() {
          ...
          let initButton = (i, s) => {
            (i &&
              i.addEventListener(
                "click",
                "next" === s ? onNextClick : onPrevClick,
              ),
              !t.enabled && i && i.classList.add(...e.lockClass.split(" ")));
          };
          (i.forEach((e) => initButton(e, "next")),
            s.forEach((e) => initButton(e, "prev")));
        }
        function destroy() {
          let { nextEl: e, prevEl: i } = t.navigation;
          ((e = makeElementsArray(e)), (i = makeElementsArray(i)));
        ...
        (s("init", () => {
          ...
          s("click", (e, i) => {
            ...
            ((s = makeElementsArray(s)), (a = makeElementsArray(a)));
            let l = i.target;
            if (
      ...
      function Pagination(e) {
        let t,
          { swiper: i, extendParams: r, on: a, emit: l } = e,
          n = "swiper-pagination";
        (r({
          pagination: {
            el: null,
        ...
        function update() {
          ...
          d = makeElementsArray(d);
          let c =
              i.virtual && i.params.virtual.enabled
                ? i.virtual.slides.length
                : i.slides.length,
            p = i.params.loop
              ? Math.ceil(c / i.params.slidesPerGroup)
              : i.snapGrid.length;
          if (
            (i.params.loop
              ...
              (n.dynamicBullets &&
                ...
                d.forEach((e) => {
                  e.style[i.isHorizontal() ? "width" : "height"] =
                    `${t * (n.dynamicMainBullets + 4)}px`;
                }),
                n.dynamicMainBullets > 1 &&
                  void 0 !== r &&
                  ((o += e - (r || 0)) > n.dynamicMainBullets - 1
            ...
            if (n.dynamicBullets) {
              let e = Math.min(u.length, n.dynamicMainBullets + 4),
                s = (t * e - t) / 2 - p * t,
                r = a ? "right" : "left";
              u.forEach((e) => {
          ...
          d.forEach((t, s) => {
            if (
              ("fraction" === n.type &&
                (t
                  .querySelectorAll(
                    classes_to_selector_classesToSelector(n.currentClass),
                  )
                  .forEach((t) => {
                ...
                t
                  .querySelectorAll(
                    classes_to_selector_classesToSelector(n.totalClass),
                  )
                  .forEach((e) => {
            ...
            ("custom" === n.type && n.renderCustom
              ? ((t.innerHTML = n.renderCustom(i, e + 1, p)),
                0 === s && l("paginationRender", t))
              : (0 === s && l("paginationRender", t), l("paginationUpdate", t)),
              i.params.watchOverflow &&
                i.enabled &&
                t.classList[i.isLocked ? "add" : "remove"](n.lockClass));
          });
        }
        function render() {
            ...
            e &&
              ...
              (e = makeElementsArray(e)).forEach((e) => {
                ("bullets" === t.type &&
                  ...
                  t.clickable && e.addEventListener("click", onBulletClick),
        ...
        function destroy() {
          ...
          (t &&
            (t = makeElementsArray(t)).forEach((t) => {
              (t.classList.remove(e.hiddenClass),
                ...
                e.clickable &&
                  ...
                  t.removeEventListener("click", onBulletClick)));
            }),
            i.pagination.bullets &&
        ...
        (a("changeDirection", () => {
          ...
          a("click", (e, t) => {
            let s = t.target,
              r = makeElementsArray(i.pagination.el);
            if (
              i.params.pagination.el &&
              ...
              (!0 === e ? l("paginationShow") : l("paginationHide"),
                r.forEach((e) =>
          ...
          r("beforeInit", () => {
            if (
              ...
              if (e && e.swiper) t.controller.control = e.swiper;
                ...
                let onControllerSwiper = (i) => {
                  ((t.controller.control = i.detail[0]),
                    t.update(),
                    e.removeEventListener("init", onControllerSwiper));
                };
                e.addEventListener("init", onControllerSwiper);
              }
              return;
            }
            ...
            setTranslate: function (e, i) {
              ...
              function setControlledTranslate(e) {
                ...
                ("slide" === t.params.controller.by &&
                  ((t.controller.spline = t.params.loop
                    ? new LinearSpline(t.slidesGrid, e.slidesGrid)
                    : new LinearSpline(t.snapGrid, e.snapGrid)),
                  ...
                  (r && "container" !== t.params.controller.by) ||
                    ((Number.isNaN(
                      ...
                      !Number.isFinite(s)) &&
                      (s = 1),
                    (r = (i - t.minTranslate()) * s + e.minTranslate())),
              ...
              if (Array.isArray(a))
                for (let e = 0; e < a.length; e += 1)
                  a[e] !== i &&
                    a[e] instanceof l &&
                    setControlledTranslate(a[e]);
              else a instanceof l && i !== a && setControlledTranslate(a);
            },
            setTransition: function (e, i) {
              let r;
              let a = t.constructor,
                l = t.controller.control;
              function setControlledTransition(i) {
                i.destroyed ||
                  (i.setTransition(e, t),
                  0 !== e &&
                    (i.transitionStart(),
              ...
              if (Array.isArray(l))
                for (r = 0; r < l.length; r += 1)
                  l[r] !== i &&
                    l[r] instanceof a &&
                    setControlledTransition(l[r]);
              else l instanceof a && i !== l && setControlledTransition(l);
            },
          }));
      }
      ...
      function effect_virtual_transition_end_effectVirtualTransitionEnd(e) {
          ...
          effect_init_effectInit({
            ...
            setTranslate: () => {
              ...
              for (let s = 0; s < e.length; s += 1) {
                ...
                let l = 0;
                t.isHorizontal() || ((l = a), (a = 0));
                let n = t.params.fadeEffect.crossFade
                    ? Math.max(1 - Math.abs(e.progress), 0)
                    : 1 + Math.min(Math.max(e.progress, -1), 0),
                  o = effect_target_effectTarget(i, e);
                ((o.style.opacity = n),
                  (o.style.transform = `translate3d(${a}px, ${l}px, 0px)`));
              }
            },
            setTransition: (e) => {
      ...
      function EffectCards(e) {
        ...
        (i({
          ...
          effect_init_effectInit({
            ...
            on: r,
            setTranslate: () => {
              let { slides: e, activeIndex: i, rtlTranslate: r } = t,
                a = t.params.cardsEffect,
                { startTranslate: l, isTouched: n } = t.touchEventsData,
              ...
              for (let d = 0; d < e.length; d += 1) {
                ...
                let f = t.params.cssMode ? -h - t.translate : -h,
                  ...
                  g = -100 * Math.abs(u),
                  v = 1,
                  w = -a.perSlideRotate * u,
                  b = a.perSlideOffset - 0.75 * Math.abs(u),
                  S =
                  ...
                  E =
                    ...
                    o > l;
                if (y || E) {
                  let e = (1 - Math.abs((Math.abs(u) - 0.5) / 0.5)) ** 0.5;
                  ((w += -28 * u * e),
                    (v += -0.5 * e),
                    (b += 96 * e),
                    (m = `${-25 * e * Math.abs(u)}%`));
      ...
      `;
                ...
                let C = effect_target_effectTarget(a, c);
                C.style.transform = x;
              }
            },
            setTransition: (e) => {
    ...
    2606: function (e, t, i) {
      ...
      function elementTransitionEnd(e, t) {
        t &&
          e.addEventListener("transitionend", function fireCallBack(i) {
            i.target === e &&
              (t.call(e, i),
              e.removeEventListener("transitionend", fireCallBack));
          });
      }
    ...
    99288: function (e, t, i) {
            ...
            ? (function (e, t) {
                return (
                  ...
                  (function __closestFrom(t) {
                    if (!t || t === (0, n.g)() || t === (0, n.a)()) return null;
      ...
      function onTouchMove(e) {
        ...
        if (
          ...
          void 0 === r.startMoving &&
            ...
            (r.startMoving = !0),
          r.isScrolling ||
            (this.zoom && this.params.zoom && this.params.zoom.enabled))
        ) {
          r.isTouched = !1;
          return;
        }
      ...
      function onTouchEnd(e) {
        ...
        if (!u || (!n.simulateTouch && "mouse" === a.pointerType)) return;
        if (
        ...
        for (
          ...
          void 0 !== p[e + t]
            ? i >= p[e] && i < p[e + t] && ((m = e), (g = p[e + t] - p[e]))
            : i >= p[e] && ((m = e), (g = p[p.length - 1] - p[p.length - 2]));
        }
        let v = null,
          w = null;
        n.rewind &&
        ...
        if (f > n.longSwipesMs) {
          ...
          ("next" === s.swipeDirection &&
            (b >= n.longSwipesRatio
              ? s.slideTo(n.rewind && s.isEnd ? v : m + S)
              : s.slideTo(m)),
          ...
          update: {
            updateSize: function () {
              ...
              ((e =
                ...
                (0 === e && this.isHorizontal()) ||
                  ...
                  ((e =
                    e -
                    parseInt((0, o.m)(i, "padding-left") || 0, 10) -
                    parseInt((0, o.m)(i, "padding-right") || 0, 10)),
                  (t =
                    t -
                    parseInt((0, o.m)(i, "padding-top") || 0, 10) -
                    parseInt((0, o.m)(i, "padding-bottom") || 0, 10)),
                  Number.isNaN(e) && (e = 0),
                  Number.isNaN(t) && (t = 0),
                  Object.assign(this, {
                    width: e,
            ...
            updateSlides: function () {
              ...
              let i = t.params,
                ...
                p = (0, o.e)(r, `.${t.params.slideClass}, swiper-slide`),
                  ...
                  if ("auto" === i.slidesPerView) {
                    ...
                    if (
                      ...
                      let t = getDirectionPropertyValue(a, "width"),
                        i = getDirectionPropertyValue(a, "padding-left"),
                        s = getDirectionPropertyValue(a, "padding-right"),
                        l = getDirectionPropertyValue(a, "margin-left"),
                        n = getDirectionPropertyValue(a, "margin-right"),
                        o = a.getPropertyValue("box-sizing");
                      if (o && "border-box" === o) e = t + l + n;
                      else {
                        let { clientWidth: a, offsetWidth: o } = r;
                        e = t + i + s + l + n + (o - a);
                      }
                    }
                    ...
                    ((e = (a - (i.slidesPerView - 1) * S) / i.slidesPerView),
                      i.roundLengths && (e = Math.floor(e)),
                      p[s] &&
            ...
            updateSlidesClasses: function () {
              ...
              (e &&
                ...
                d
                  ...
                  : ((i = (0, o.o)(e, `.${r.slideClass}, swiper-slide`)[0]),
                    r.loop && !i && (i = s[0]),
                    i && i.classList.add(r.slideNextClass),
                    (t = (0, o.p)(e, `.${r.slideClass}, swiper-slide`)[0]),
                    r.loop),
      ...
      let Swiper = class Swiper {
        constructor() {
          let e, t;
          for (var i, s = arguments.length, l = Array(s), c = 0; c < s; c++)
            l[c] = arguments[c];
          (1 === l.length &&
          l[0].constructor &&
          "Object" === Object.prototype.toString.call(l[0]).slice(8, -1)
            ? (t = l[0])
            : ([e, t] = l),
            t || (t = {}),
            (t = (0, o.t)({}, t)),
          ...
          if (
            ...
            let e = [];
            return (
              u.querySelectorAll(t.el).forEach((i) => {
                let s = (0, o.t)({}, t, { el: i });
                e.push(new Swiper(s));
              }),
              e
          ...
          let m = (0, o.t)({}, d, f);
          return (
            (h.params = (0, o.t)({}, m, p, t)),
            (h.originalParams = (0, o.t)({}, h.params)),
            (h.passedParams = (0, o.t)({}, t)),
            h.params &&
              h.params.on &&
          ...
          return (
            ...
            Object.assign(t, {
              ...
              rtl:
                ...
                "rtl" === (0, o.m)(i, "direction"),
              rtlTranslate:
                "horizontal" === t.params.direction &&
                ("rtl" === i.dir.toLowerCase() ||
                  "rtl" === (0, o.m)(i, "direction")),
              wrongRTL: "-webkit-box" === (0, o.m)(s, "display"),
            }),
            !0
          );
        }
      ...
      let h = (0, l.createContext)(null),
        ...
        m = (0, l.forwardRef)(function (e, t) {
          ...
          let initSwiper = () => {
            (Object.assign(L.on, A), (p = !0));
            let e = { ...L };
            if (
              (delete e.wrapperClass,
              (E.current = new Swiper(e)),
              ...
              (extend(E.current.params.virtual, e),
                extend(E.current.originalParams.virtual, e));
            }
          };
          (y.current || initSwiper(),
            E.current && E.current.on("_beforeBreakpoint", onBeforeBreakpoint));
          let attachEvents = () => {
              !p &&
                A &&
                E.current &&
          ...
          return (
            (0, l.useEffect)(() => () => {
              E.current &&
                E.current.off("_beforeBreakpoint", onBeforeBreakpoint);
            }),
            (0, l.useEffect)(() => {
              !S.current &&
                E.current &&
            ...
            useIsomorphicLayoutEffect(() => {
              if ((t && (t.current = y.current), y.current))
                return (
                  E.current.destroyed && initSwiper(),
                  (function (e, t) {
                    let {
                      el: i,
                      nextEl: s,
            ...
            useIsomorphicLayoutEffect(() => {
              ...
              })(_, T.current, I, x.current, (e) => e.key);
              return (
                (T.current = _),
                (x.current = I),
                e.length &&
            ...
            l.createElement(
              ...
              l.createElement(
                ...
                l.createElement(
                  a,
                  {
                    className: (void 0 === (i = L.wrapperClass) && (i = ""), i)
                    ...
                    ? (function (e, t, i) {
                        ...
                        let getSlideIndex = (e) => {
                          ...
                          s = e.isHorizontal()
                            ...
                            : { top: `${i.offset}px` },
                          { from: r, to: a } = i,
                          n = e.params.loop ? -t.length : 0,
                          o = e.params.loop ? 2 * t.length : t.length,
                          d = [];
                        for (let e = n; e < o; e += 1)
                          e >= r && e <= a && d.push(t[getSlideIndex(e)]);
                        return d.map((t, i) =>
                          l.cloneElement(t, {
                            swiper: e,
                            style: s,
      ...
      let g = (0, l.forwardRef)(function (e, t) {
        let {
            tag: i = "div",
            children: s,
            className: r = "",
        ...
        (useIsomorphicLayoutEffect(() => {
          if (
            ...
            return (
              a.on("_slideClass", updateClasses),
              () => {
